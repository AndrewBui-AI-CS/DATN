...
import wms.domain.category.dao.*;
import wms.domain.category.entity.*;
...
public class CategoryServiceImpl extends BaseService implements ICategoryService {
    ...
    public void deleteProductUnitByCode(String code) throws CustomException {
        ...
        if (productUnit == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Product unit not exists, can't delete");
        }
    ...
    public void deleteProductCategoryByCode(String code) throws CustomException {
        ...
        if (productCategory == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Product category not exists, can't delete");
        }
    ...
    public void deleteCustomerTypeByCode(String code) throws CustomException {
        ...
        if (customerType == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Customer type does not exists, can't delete");
        }
    ...
    public void deleteDistributingChannelByCode(String code) throws CustomException {
        ...
        if (distributingChannel == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Distribution channel not exists, can't delete");
        }
    ...
    public ContractType createContractType(ContractTypeDTO contractTypeDTO) throws CustomException {
        ...
        if (channel == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Contract type with no specific distributing channel, can't create");
        }
    ...
    public void deleteContractTypeByCode(String code) throws CustomException {
        ...
        if (currContract == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Contract type not exists, can't delete");
        }
