...
import wms.domain.delivery.dao.ShipmentRepo;
...
import wms.domain.delivery.service.delivery_trip.IDeliveryTripService;
...
public class ShipmentServiceImpl extends BaseService implements IShipmentService {
    ...
    public ShipmentItem createShipmentItem(ShipmentItemDTO shipmentItemDTO) throws CustomException {
        ...
        if (deliveryBill == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Can't find referenced bill, can't create");
        }
    ...
    public Shipment updateShipment(ShipmentDTO shipmentDTO, Long id) throws CustomException {
        ...
        if (shipment == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(),  "Can not find shipment with this id: " + id);
        }
    ...
    public void assignShipmentItem(AssignedItemDTO assignedItemDTO) throws CustomException {
        ...
        if (shipmentItem == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Shipment item not exists");
        }
        if (assignedTrip == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Can't find assigned trip item not exists");
        }
