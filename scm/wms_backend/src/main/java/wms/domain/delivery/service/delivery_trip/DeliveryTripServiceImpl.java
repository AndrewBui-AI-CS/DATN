package wms.domain.delivery.service.delivery_trip;
...
import wms.domain.delivery.dao.*;
import wms.domain.delivery.dto.delivery_trip.DeliveryTripDTO;
import wms.domain.delivery.dto.delivery_trip.TripRouteDTO;
import wms.domain.delivery.entity.*;
...
import wms.domain.delivery.service.delivery_bill.IDeliveryBillService;
...
public class DeliveryTripServiceImpl extends BaseService implements IDeliveryTripService {
    ...
    public DeliveryTrip createDeliveryTrip(DeliveryTripDTO deliveryTripDTO, JwtAuthenticationToken token) throws CustomException {
        ...
        if (createdBy == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Unknown staff create this shipment, can't create");
        }
        if (shipment == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Not found shipment for this trip, can't create");
        }
        if (facility == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Not found facility for this trip, can't create");
        }
    ...
    public DeliveryTrip updateDeliveryTrip(DeliveryTripDTO deliveryTripDTO, long id) throws CustomException {
        ...
        Facility facility = facilityRepo.getFacilityByCode(deliveryTripDTO.getFacilityCode());
        if (shipment == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Not found shipment for this trip, can't update");
        }
        if (userInCharge == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Not found user in charge for this trip, can't update");
        }
        if (facility == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Not found facility for this trip, can't update");
        }
