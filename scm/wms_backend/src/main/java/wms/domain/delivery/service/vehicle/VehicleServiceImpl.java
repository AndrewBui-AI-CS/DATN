...
import wms.domain.delivery.dao.DroneRepo;
import wms.domain.delivery.dao.TruckRepo;
...
public class VehicleServiceImpl extends BaseService implements IVehicleService {
    ...
    public TruckEntity createTruck(TruckDTO truckDTO) throws CustomException {
        ...
        if (truck != null) {
            throw caughtException(ResponseCode.ALREADY_EXIST.getCode(), "User has been in charged of another truck");
        }
    ...
    public TruckEntity updateTruck(TruckDTO truckDTO, long id) throws CustomException {
        ...
        if (listManager.size() > 0) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Manager has been in charged of another truck");
        }
        if (truck == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Unknown truck");
        }
    ...
    public void deleteTruckByCode(String code) throws CustomException {
        ...
        if (truck == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Truck does not exists, can't delete");
        }
        truck.setDeleted(1);
    ...
    public DroneEntity createDrone(DroneDTO droneDTO) throws CustomException {
        ...
        if (truck != null) {
            throw caughtException(ResponseCode.ALREADY_EXIST.getCode(), "User has been in charged of another drone");
        }
    ...
    public DroneEntity updateDrone(DroneDTO droneDTO, long id) throws CustomException {
        ...
        if (listManager.size() > 0) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Manager has been in charged of another drone");
        }
        if (drone == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Unknown drone");
        }
    ...
    public void deleteDroneByCode(String code) throws CustomException {
        ...
        if (drone == null) {
            throw caughtException(ResponseCode.NON_EXIST.getCode(), "Drone does not exists, can't delete");
        }
        drone.setDeleted(1);
